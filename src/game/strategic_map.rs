...
impl CityData {
    pub fn new(race: BuildingType, tier: u8, mut rng: &mut ResMut<GlobalRng>) -> CityData {
        ...
        for _ in 0..buildings_per_tier.0 {
            t1.push((
        ...
        for _ in 0..buildings_per_tier.1 {
            t2.push((
        ...
        for _ in 0..buildings_per_tier.2 {
            t3.push((
        ...
        for _ in 0..buildings_per_tier.3 {
            t4.push((
        ...
        for _ in 0..buildings_per_tier.4 {
            t5.push((
    ...
    pub fn update_market(&mut self, building_table: &Res<BuildinTable>) {
        ...
        match match_condition {
            1 => {
                tier_up(
                    self.market
                        .insert(Resources::Food, self.market[&Resources::Food] - 5)
                        .expect("error in city market")
                        - 5
                        >= 0
                        && self
                            .market
                            .insert(Resources::Water, self.market[&Resources::Water] - 3)
                            .expect("error in city market")
                            - 3
                            >= 0
                        && self
                            .market
                            .insert(Resources::Lumber, self.market[&Resources::Lumber] - 2)
                            .expect("error in city market")
                            - 2
                            >= 0,
                );
                self.market.insert(
                    ...
                    self.market[&Resources::SimpleLabour] + 5,
                );
            }
            2 => {
                tier_up(
                    self.market
                        .insert(Resources::Food, self.market[&Resources::Food] - 15)
                        .expect("error in city market")
                        - 15
                        >= 0
                        && self
                            .market
                            .insert(Resources::Water, self.market[&Resources::Water] - 10)
                            .expect("error in city market")
                            - 10
                            >= 0
                        && self
                            .market
                            .insert(Resources::Lumber, self.market[&Resources::Lumber] - 5)
                            .expect("error in city market")
                            - 5
                            >= 0
                        && self
                            .market
                            .insert(Resources::Stone, self.market[&Resources::Stone] - 3)
                            .expect("error in city market")
                            - 3
                            >= 0
                        && self
                            .market
                            .insert(Resources::Glass, self.market[&Resources::Glass] - 3)
                            .expect("error in city market")
                            - 3
                            >= 0
                        && self
                            .market
                            .insert(Resources::Textiles, self.market[&Resources::Textiles] - 3)
                            .expect("error in city market")
                            - 3
                            >= 0,
                );
                self.market.insert(
                    Resources::SimpleLabour,
                    self.market[&Resources::SimpleLabour] + 20,
                );
                self.market.insert(
                    Resources::ComplexLabour,
                    self.market[&Resources::ComplexLabour] + 5,
                );
            }
            3 => {
                tier_up(
                    self.market
                        .insert(Resources::Food, self.market[&Resources::Food] - 20)
                        .expect("error in city market")
                        - 20
                        >= 0
                        && self
                            .market
                            .insert(Resources::Water, self.market[&Resources::Water] - 15)
                            .expect("error in city market")
                            - 15
                            >= 0
                        && self
                            .market
                            .insert(Resources::Lumber, self.market[&Resources::Lumber] - 10)
                            .expect("error in city market")
                            - 10
                            >= 0
                        && self
                            .market
                            .insert(Resources::Stone, self.market[&Resources::Stone] - 6)
                            .expect("error in city market")
                            - 6
                            >= 0
                        && self
                            .market
                            .insert(Resources::Glass, self.market[&Resources::Glass] - 6)
                            .expect("error in city market")
                            - 6
                            >= 0
                        && self
                            .market
                            .insert(Resources::Textiles, self.market[&Resources::Textiles] - 6)
                            .expect("error in city market")
                            - 6
                            >= 0
                        && self
                            .market
                            .insert(Resources::Medicines, self.market[&Resources::Medicines] - 3)
                            .expect("error in city market")
                            - 3
                            >= 0
                        && self
                            ...
                            .insert(
                                ...
                                self.market[&Resources::ManufacturedGoods] - 3,
                            )
                            .expect("error in city market")
                            - 3
                            >= 0
                        && self
                            .market
                            .insert(Resources::Luxuries, self.market[&Resources::Luxuries] - 15)
                            .expect("error in city market")
                            - 15
                            >= 0
                        && self
                            ...
                            .insert(
                                ...
                                self.market[&Resources::Transportation] - 15,
                            )
                            .expect("error in city market")
                            - 15
                            >= 0,
                ...
                self.market
                    .insert(Resources::Drugs, self.market[&Resources::Drugs] - 5)
                    .expect("error in city market");
                self.market
                    .insert(Resources::Slaves, self.market[&Resources::Slaves] - 5)
                    .expect("error in city market");
                self.market.insert(
                    Resources::SimpleLabour,
                    self.market[&Resources::SimpleLabour] + 45,
                );
                self.market.insert(
                    Resources::ComplexLabour,
                    self.market[&Resources::ComplexLabour] + 20,
                );
            }
            4 => {
                tier_up(
                    self.market
                        .insert(Resources::Food, self.market[&Resources::Food] - 50)
                        .expect("error in city market")
                        - 50
                        >= 0
                        && self
                            .market
                            .insert(Resources::Water, self.market[&Resources::Water] - 30)
                            .expect("error in city market")
                            - 30
                            >= 0
                        && self
                            .market
                            .insert(Resources::Lumber, self.market[&Resources::Lumber] - 20)
                            .expect("error in city market")
                            - 20
                            >= 0
                        && self
                            .market
                            .insert(Resources::Stone, self.market[&Resources::Stone] - 15)
                            .expect("error in city market")
                            - 15
                            >= 0
                        && self
                            .market
                            .insert(Resources::Glass, self.market[&Resources::Glass] - 15)
                            .expect("error in city market")
                            - 15
                            >= 0
                        && self
                            .market
                            .insert(Resources::Textiles, self.market[&Resources::Textiles] - 15)
                            .expect("error in city market")
                            - 15
                            >= 0
                        && self
                            ...
                            .insert(
                                Resources::Medicines,
                                self.market[&Resources::Medicines] - 10,
                            )
                            .expect("error in city market")
                            - 10
                            >= 0
                        && self
                            ...
                            .insert(
                                Resources::ManufacturedGoods,
                                self.market[&Resources::ManufacturedGoods] - 10,
                            )
                            .expect("error in city market")
                            - 10
                            >= 0
                        && self
                            .market
                            .insert(Resources::Luxuries, self.market[&Resources::Luxuries] - 25)
                            .expect("error in city market")
                            - 25
                            >= 0
                        && self
                            ...
                            .insert(
                                Resources::Transportation,
                                self.market[&Resources::Transportation] - 25,
                            )
                            .expect("error in city market")
                            - 25
                            >= 0
                        && self
                            .market
                            .insert(Resources::Military, self.market[&Resources::Military] - 15)
                            .expect("error in city market")
                            - 15
                            >= 0,
                );
                self.market
                    .insert(Resources::Drugs, self.market[&Resources::Drugs] - 10)
                    .expect("error in city market");
                self.market
                    .insert(Resources::Slaves, self.market[&Resources::Slaves] - 10)
                    .expect("error in city market");
                self.market
                    .insert(Resources::Vitae, self.market[&Resources::Vitae] - 2)
                    .expect("error in city market");
                self.market.insert(
                    Resources::SimpleLabour,
                    self.market[&Resources::SimpleLabour] + 80,
                );
                self.market.insert(
                    Resources::ComplexLabour,
                    self.market[&Resources::ComplexLabour] + 45,
                );
            }
            5 => {
                self.market
                    .insert(Resources::Food, self.market[&Resources::Food] - 100);
                self.market
                    .insert(Resources::Water, self.market[&Resources::Water] - 50);
                self.market
                    .insert(Resources::Lumber, self.market[&Resources::Lumber] - 40);
                self.market
                    .insert(Resources::Stone, self.market[&Resources::Stone] - 30);
                self.market
                    .insert(Resources::Glass, self.market[&Resources::Glass] - 30);
                self.market
                    .insert(Resources::Textiles, self.market[&Resources::Textiles] - 20);
                self.market.insert(
                    Resources::Medicines,
                    self.market[&Resources::Medicines] - 20,
                );
                self.market.insert(
                    Resources::ManufacturedGoods,
                    self.market[&Resources::ManufacturedGoods] - 20,
                );
                self.market
                    .insert(Resources::Luxuries, self.market[&Resources::Luxuries] - 60);
                self.market.insert(
                    Resources::Transportation,
                    self.market[&Resources::Transportation] - 60,
                );
                self.market
                    .insert(Resources::Military, self.market[&Resources::Military] - 50);
                self.market
                    .insert(Resources::Drugs, self.market[&Resources::Drugs] - 20)
                    .expect("error in city market");
                self.market
                    .insert(Resources::Slaves, self.market[&Resources::Slaves] - 20)
                    .expect("error in city market");
                self.market
                    .insert(Resources::Vitae, self.market[&Resources::Vitae] - 5)
                    .expect("error in city market");
                self.market.insert(
                    Resources::SimpleLabour,
                    self.market[&Resources::SimpleLabour] + 125,
                );
                self.market.insert(
                    Resources::ComplexLabour,
                    self.market[&Resources::ComplexLabour] + 80,
                );
            }
            _ => {
                panic!(
                    "Tried to update markets on a city of tier {:?}",
                    self.population
                )
            }
        }
